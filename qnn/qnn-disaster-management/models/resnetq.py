    ...
    def __init__(self, in_chan, out_chan, stride=1, norm_layer=None):
        ...
        if in_chan != out_chan or stride != 1:
            self.downsample = nn.Sequential(
                ...
                QuaternionConv(in_chan, out_chan, kernel_size=1, stride=stride, bias=False),
...
class ResNet(nn.Module):
    def __init__(self, block, layers, strides, norm_layer=None):
        ...
        self.conv1 = QuaternionConv(3, 64, kernel_size=7, stride=2, groups=1, padding=3, bias=False)
